...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button id="notificationSettingsBtn" class="inline-flex items-center gap-2 bg-indigo-500 hover:bg-indigo-700 text-white px-3 py-2 rounded-md text-sm font-medium transition-colors" title="Notification Settings">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="notificationSettingsModal" class="hidden fixed z-10 inset-0 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            <div class="flex-1">
                                <label for="soundToggle" class="text-sm font-medium text-gray-900">Notification Sound</label>
                                <p class="text-xs text-gray-500 mt-1">Play a sound when new access requests arrive</p>
                            </div>
                            <button id="soundToggle" type="button" class="ml-4 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 bg-gray-200" role="switch" aria-checked="true">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3 flex-1">
                                    <p class="text-sm text-blue-700">
                                        You'll receive notifications when users request access to your prompts. These appear in the top-right corner and auto-dismiss after 10 seconds.
                                    </p>
                                </div>
                            </div>
                        </div>
